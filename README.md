...
* https://petersm3.github.io/browser-rewrite
  * Pure client-side rewrite of the PHP/MySQL application. The browser loads a pre-built SQLite database via WebAssembly and runs all queries locally. ff61fae0d6935a05b5bc64ff7c9333210b04e344
